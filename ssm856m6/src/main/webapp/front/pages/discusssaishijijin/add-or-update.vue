	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusssaishijijin`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
				...
				if(this.ruleForm.id){
					await this.$api.update(`discusssaishijijin`, this.ruleForm);
				}else{
					await this.$api.add(`discusssaishijijin`, this.ruleForm);
				}
				uni.setStorageSync('discusssaishijijinCleanType',true);
