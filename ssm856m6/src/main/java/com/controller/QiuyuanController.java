...
public class QiuyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		QiuyuanEntity user = qiuyuanService.selectOne(new EntityWrapper<QiuyuanEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"qiuyuan",  "球员" );
    ...
    public R register(@RequestBody QiuyuanEntity qiuyuan){
    	//ValidatorUtils.validateEntity(qiuyuan);
    	QiuyuanEntity user = qiuyuanService.selectOne(new EntityWrapper<QiuyuanEntity>().eq("zhanghao", qiuyuan.getZhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        QiuyuanEntity user = qiuyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
    	...
    	user.setMima("123456");
        qiuyuanService.updateById(user);
    ...
    public R save(@RequestBody QiuyuanEntity qiuyuan, HttpServletRequest request){
		...
		qiuyuan.setId(new Date().getTime());
        qiuyuanService.insert(qiuyuan);
        return R.ok();
    }
